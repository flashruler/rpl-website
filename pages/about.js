      ...
      <div className="w-screen flex flex-col items-center  bg-cover bg-black">
        ...
        <div className="z-10 w-4/5 p-3 mb-5">
          <h1 className="text-white text-xl font-extralight text-center">
            ...
            by Cameron Flannery, Michael Phalen, and Alex Lim. RPL&apos;s goal
            is to provide student-led research opportunities for students
            passionate about space exploration. We strive to provide challenging
            and exciting projects for students to develop their technical
            knowledge, leadership abilities, and hands-on skills.
          </h1>
        </div>
      </div>
